...
public class MessageBroker {
    ...
    private MessageBroker() {
        ...
        try {
            Intent service = new Intent(mContext, NewsService.class);
            mContext.startService( service );
            mContext.bindService( service, mConnection,
        ...
        ReaderController.getInstance(mContext);
        ...
        if (request instanceof MBRequest) {
            ...
            switch (requestId) {
                ...
                case Constants.MSG_UPLOAD_TO_SERVER:
                    ...
                    break;
                case Constants.MSG_FILTER_BY_EMAIL:
    ...
    private void filterNewsByEmail( MBRequest request ) {
        newsService.filterNewsByEmail(request);
    }
    ...
    private ModelDistribution getModelDistributions( MBRequest mbRequest ){
        return newsService.getModelDistributions( mbRequest );
    }
